        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
              <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link" aria-current="page" href="{{ 'prestamos' }}">Préstamos</a>
                </li>
                <li class="nav-item">
        ...
        <div class="collapse mt-3" id="agregarForm">
            ...
            @csrf
                <div class="form-group">
                    ...
                    <input name="name" type="text" class="form-control editable-field" id="name">
                </div>
                <div class="form-group">
                    <label for="apellidoP">Apellido Paterno</label>
                    <input name="apellidoP" type="text" class="form-control editable-field" id="apellidoP">
                </div>
                <div class="form-group">
                    <label for="apellidoM">Apellido Materno</label>
                    <input name="apellidoM" type="text" class="form-control editable-field" id="apellidoM">
                </div>
                <div class="form-group">
                    <label for="clave">Clave</label>
                    <input name="clave" type="number" class="form-control editable-field" id="clave">
                </div>
                <br>
